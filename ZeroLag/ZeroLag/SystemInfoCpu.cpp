...
bool CSystemInfoCpu::withMMX()
{
	return MMX;
}

int CSystemInfoCpu::GetFamily()
{
	return iFamily;
}

int CSystemInfoCpu::GetName(char *name)
{
...
int CSystemInfoCpu::GetTypeName(char *type)
{
	//EAX的8到11位表明是几86：
	//                  3 - 386
	//                  4 - i486
