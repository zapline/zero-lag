...
//template class KUILIB_API std::map<std::string, std::string>;
//template class KUILIB_API std::pair<unsigned long, unsigned long>;
//template class KUILIB_API std::map<std::string, KResInfo>;
//template class KUILIB_API std::map<std::string, std::wstring>;
//template class KUILIB_API std::map<std::string, std::string>;
//template class KUILIB_API std::map<std::string, HBITMAP>;
//template class KUILIB_API std::map<std::string, IUnknown*>;
//template class KUILIB_API std::map<std::string, Gdiplus::Image*>;
//template class KUILIB_API std::map<std::string, std::string>;
//template class KUILIB_API std::map<std::string, HFONT>;
//template class KUILIB_API std::map<std::string, COLORREF>;
