...
#include <ocidl.h>
#include <olectl.h>
#include "../../Include/kscbase/kscres.h"
#include "../../3Party/zlib/unzip.h"
#include "../../3Party/zlib/iowin32.h"
#include "../../Include/kscbase/kscfilepath.h"
...
namespace
{
		...
		BOOL fBold = 0, BOOL fUnderline = 0, BOOL fItalic = 0)
	{
		...
		wcsncpy(logFont.lfFaceName, strFontFace.c_str(), 30);
